...
public class HtmlUtil {
     ...
     * 生成完整的HTML文档
     *
     * @param newsDetailBean NewsDetailBean
     * @return String
     */
    public static String createHtmlData(NewsDetailBean newsDetailBean) {
        final String css = HtmlUtil.createCssTag(newsDetailBean.getCss());
        final String js = HtmlUtil.createJsTag(newsDetailBean.getJs());
        return createHtmlData(newsDetailBean.getBody(), css, js);
    }
